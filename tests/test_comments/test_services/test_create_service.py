...
class TestCommentCreateService(CommentBaseTest):
    ...
    def test_create_comment_content(self) -> None:
        ...
        new_comment = create_comment(self.data_for_content, self.user)
    ...
    def test_create_comment_img(self) -> None:
        ...
        new_comment = create_comment(self.data_for_img, self.user)
        self.assertEqual(Comment.objects.count(), 3)
    ...
    def test_fail_create_comment(self) -> None:
        ...
        with self.assertRaises(NotFoundException):
            create_comment(self.fail_data_for_none_post, self.user)
