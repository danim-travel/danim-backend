...
class FollowingServiceTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.target = make_user(1)  # 팔로잉 목록의 주인
        cls.followee_a = make_user(2)  # target이 팔로우하는 사람
        cls.followee_b = make_user(3)  # target이 팔로우하는 사람
