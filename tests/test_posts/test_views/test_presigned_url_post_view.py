...
class PresignedUrlPostViewTest(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.mock_s3.create_key.return_value = "dev/upload/image/post/uuid.png"
        self.mock_s3.create_img_url.return_value = (
            "https://bucket.s3.region.amazonaws.com/dev/upload/image/post/uuid.png"
        )
    ...
    def test_presigned_url_success(self) -> None:
        """게시글 이미지 presigned URL 발급 성공"""
        response = self.client.post(
            reverse("posts:presigned_url_post"),
            {"original_img": "jeju.png"},
        )
